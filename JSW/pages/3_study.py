...
# 질문 파일 경로 매핑
questions_folder = "C:/Users/user/RAG_project/JSW/Question/"

topic_file_mapping = {
    "파이썬": "Question/python_module.txt",
    "머신러닝": "Question/machine_learning_module.txt",
    "딥러닝": "Question/deep_learning_module.txt",
    "데이터구조": "Question/data_structure_module.txt",
    "운영체제": "Question/opearting_system_module.txt",
    "네트워크": "Question/network_module.txt",
    "통계": "Question/statistic_module.txt",
    "알고리즘": "Question/algorithm_module.txt",
}

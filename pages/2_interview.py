...
feedback_prompt = load_prompt("C:/Users/user/RAG_project/LDW/prompt/feedback_prompt.yaml")  # 피드백용 지시사항
question_prompt = load_prompt("C:/Users/user/RAG_project/LDW/prompt/question_prompt.yaml")  # 질문용 지시사항
